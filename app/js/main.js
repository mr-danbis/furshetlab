$(document).ready(function () {
  ...
  function resizePaddingLeft() {
    ...
    returnContent.style.marginLeft =
  ...
  function accountTabs() {
    ...
    accountNav.addEventListener("click", (e) => {
      if (
        e.target &&
        !e.target.classList.contains(activeTabClass) &&
        e.target.classList.contains("account__nav-item")
      ) {
  ...
  function showingFullComment() {
    const showMoreCommentBtn = document.querySelectorAll(
      ".reviews__slider-item_more"
    );

    showMoreCommentBtn.forEach((btn) => {
      btn.addEventListener("click", (e) => {
        let clickedItem = e.target.parentNode.parentNode;
        let clickedText = clickedItem.querySelector(
          ".reviews__slider-item_text"
        );
  ...
  function productTabs() {
    var productNav = $(".product__description-navigation_btn");
    var productContent = $(".product__description-text");
